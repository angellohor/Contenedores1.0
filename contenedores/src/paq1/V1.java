...
public class V1 extends JFrame{
    ...
    public V1 (){
        almacen p1 = new almacen();
        contenedor c = new contenedor();
        setContentPane(mainpanel);
        setTitle("GestionDeContenedores");
        setSize(900,500);
        matriz.setText(p1.tostring());
        ...
        desapilarButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                p1.desapilacontenedor(Integer.parseInt(numeroDeColumnaTextField.getText()));
        ...
        mostrarDatosDelContenedorButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                p1.muestracontainer(Integer.parseInt(IDContenedorTextField.getText()));
            }
        });
        cuantosButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                cuantp.setText(String.valueOf(p1.cuantosa((String)comboBox2.getSelectedItem())));
